...
import com.nhom7.web.validator.BookValidator;
...
//				bookService.updatecount(book, order, orderDetail, request);
//			}
//		}
	...
	public String editOrder(Model model, HttpServletRequest request) throws IOException {
		int id = Integer.valueOf(request.getParameter("id"));
